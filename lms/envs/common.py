...
DEFAULT_COURSE_ABOUT_IMAGE_URL = 'images/tum-fahnen.jpg'
...
TIME_ZONE = 'Europe/Berlin'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
...
# visible. We default this to the legacy permission 'see_about_page'.
