...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(post_type)s posted %(time_ago)s by %(author)s": "%(post_type)s geschrieben %(time_ago)s von %(author)s", 
    "%(value)s hour": [
      "%(value)s Stunde", 
      "%(value)s Stunden"
    ], 
    ...
    "Add Students": "Studenten hinzuf\u00fcgen", 
    ...
    "Add a clear and descriptive title to encourage participation.": "F\u00fcgen Sie einen klaren und erkl\u00e4renden Titel hinzu, um andere zur Diskussionsteilnahme anzuregen.", 
    "Add a comment": "Einen Kommentar hinzuf\u00fcgen", 
    "Add another group": "Gruppe hinzuf\u00fcgen", 
    "Add language": "Sprache hinzuf\u00fcgen", 
    "Add students to this cohort": "Studenten zu diese Kohorte hinzuf\u00fcgen", 
    ...
    "Answers to this problem are now shown. Navigate through the problem to review it with answers inline.": "Die richtigen Antworten werden jetzt angezeigt. Steuern Sie durch die Aufgabenstellung um sie mit den angezeigten Antworten zu vergleichen.", 
    ...
    "Assign students to cohorts by uploading a CSV file": "Studenten zu einer Kohorte zuordnen durch das Hochladen von eine CSV Datei", 
    ...
    "Delete student '<%= student_id %>'s state on problem '<%= problem_id %>'?": "Antwort des Teilnehmers '<%= student_id %>'s f\u00fcr die Fragestellung '<%= problem_id %>' l\u00f6schen?", 
    ...
    "Draft saved on %(last_saved_date)s by %(edit_username)s": "Entwurf gespeichert am %(last_saved_date)s von %(edit_username)s", 
    ...
    "Enter email addresses and/or usernames, separated by new lines or commas, for the students you want to add. *": "Gebe ein die E-Mail Adressen und/oder Benutzernamen getrennt durch Zeilenumbr\u00fcche oder Komma f\u00fcr der Student sie anmelden wollen.", 
    ...
    "Error deleting student '<%= student_id %>'s state on problem '<%= problem_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Es ist ein Fehler beim L\u00f6schen der Antworten f\u00fcr die Fragestellung '<%= problem_id %>' und dem Teilnehmer '<%= student_id %>' aufgetreten. Pr\u00fcfe, ob die Fragestellungs- und Teilnehmercodes vollst\u00e4ndig und richtig sind.", 
    ...
    "Error getting student progress url for '<%= student_id %>'. Make sure that the student identifier is spelled correctly.": "Es ist ein Fehler beim Aufrufen der Teilnehmerfortschritts-URL f\u00fcr '<%= student_id %>' aufgetreten. Vergewissere dich, ob der Teilnehmercode richtig geschrieben wurde.", 
    "Error getting task history for problem '<%= problem_id %>' and student '<%= student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Fehler beim Aufrufen des Aufgabenverlaufs f\u00fcr die Fragestellung '<%= problem_id %>' und Teilnehmer '<%= student_id %>'. Pr\u00fcfe, ob die Fragestellungs- und Teilnehmercodes vollst\u00e4ndig und richtig sind.", 
    ...
    "Error starting a task to rescore problem '<%= problem_id %>' for student '<%= student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Fehler beim Starten der Aufgabe der Neubewertungsfragestellung '<%= problem_id %>' f\u00fcr Teilnehmer '<%= student_id %>'. Pr\u00fcfe, ob die Fragestellungs- und Teilnehmercodes vollst\u00e4ndig und richtig sind.", 
    "Error starting a task to rescore problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Fehler beim Starten der Aufgabe f\u00fcr die Neubewertung von Fragestellungen '<%= problem_id %>'. Pr\u00fcfe, ob der Fragestellungscode vollst\u00e4ndig und richtig ist.", 
    "Error starting a task to reset attempts for all students on problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Fehler beim Starten der Aufgabe die Versuche von allen Teilnehmern f\u00fcr Fragestellung '<%= problem_id %>' zur\u00fcckzusetzen. Pr\u00fcfe, ob der Fragestellungscode vollst\u00e4ndig und richtig ist.", 
    ...
    "Load next %(num_items)s result": [
      "%(num_items)s weiteres Ergebnis laden ", 
      "Weitere %(num_items)s Ergebnisse laden "
    ], 
    "Loading": "Ladevorgang", 
    ...
    "Manage Students": "Studenten leiten", 
    "Manual": "Handbuch", 
    ...
    "New to %(platformName)s?": "Neu bei %(platformName)s?", 
    ...
    "Note": "Anmerkung", 
    "Note: Students can be in only one cohort. Adding students to this group overrides any previous group assignment.": "Anmerkung: Studenten d\u00fcrfen nur an eine Kohorte teilnehmen. Der Zusatz von Studenten zur dieser Gruppe \u00fcberschreibt vorherige Zuordnungen. ", 
    ...
    "Required field": "Erforderliches Feld", 
    "Required field.": "Erforderliches Feld.", 
    "Rescore problem '<%= problem_id %>' for all students?": "Fragestellung '<%= problem_id %>' f\u00fcr alle Teilnehmer neu bewerten?", 
    "Reset Password": "Passwort zur\u00fccksetzen", 
    "Reset Your Password": "Passwort zur\u00fccksetzen", 
    "Reset attempts for all students on problem '<%= problem_id %>'?": "Setze f\u00fcr alle Teilnehmer die Versuche an der Fragestellung  '<%= problem_id %>' zur\u00fcck?", 
    ...
    "Started rescore problem task for problem '<%= problem_id %>' and student '<%= student_id %>'. Click the 'Show Background Task History for Student' button to see the status of the task.": "Neubewertungsaufgabe f\u00fcr die Fragestellung  '<%= problem_id %>' und Teilnehmer '<%= student_id %>' gestartet. Klicke den 'Zeige den Verlauf f\u00fcr Hintergrundsaufgaben des Teilnehmers'-Knopf um den Status der Aufgabe anzuzeigen.", 
    "Starts": "Beginnt", 
    ...
    "Student": "Teilnehmer", 
    "Student username/email field is required and can not be empty. ": "Das Benutzernamen/E-Mail-Feld wird ben\u00f6tigt und darf nicht leer sein.", 
    "Studio's having trouble saving your work": "Studio's hat Probleme beim Speichern Ihrer Arbeit", 
    "Studio:": "Studio:", 
    "Style": "Stil", 
    "Subject": "Betreff", 
    "Subject:": "Betreff:", 
    "Submission aborted! Sorry, your browser does not support file uploads. If you can, please use Chrome or Safari which have been verified to support file uploads.": "Einreichung abgebrochen! Entshculdigung, Ihr Browser unterst\u00fctzt keinen Dateiupload. Benutzen Sie bitte Chrome oder Safari. Diese Browser sind f\u00fcr den Dateiupload zertifiziert.", 
    "Submit": "Absenden", 
    "Submitted": "Abgesendet", 
    "Subscript": "Tiefgestellt", 
    "Subsection": "Unterabschnitt", 
    "Success": "Operation Erfolgreich", 
    "Success! Problem attempts reset for problem '<%= problem_id %>' and student '<%= student_id %>'.": "Erfolg! Die L\u00f6sungsversuche f\u00fcr die Fragestellung '<%= problem_id %>' und Teilnehmer '<%= student_id %>' wurden zur\u00fcckgesetzt.", 
    ...
    "Successfully sent enrollment emails to the following users. They will be allowed to enroll once they register:": "An folgende Nutzer wurden erfolgreich E-Mails zur Einschreibung versandt. Sobald sie sich registriert haben, k\u00f6nnen sie sich einschreiben: ", 
    "Successfully sent enrollment emails to the following users. They will be enrolled once they register:": "An folgende Teilnehmer wurde erfolgreich eine E-Mail bez\u00fcgliche der Einschreibung versandt. Sie werden eingeschrieben, sobald sie sich registriert haben: ", 
    "Successfully started task to rescore problem '<%= problem_id %>' for all students. Click the 'Show Background Task History for Problem' button to see the status of the task.": "Die Neubewertungsaufgabe f\u00fcr Fragestellungen '<%= problem_id %>' f\u00fcr alle Teilnehmer wurde erfolgreich gestartet. Klicke auf den 'Zeige den Verlauf f\u00fcr Hintergrundsaufgaben des Teilnehmers'-Knopf um den Status der Aufgabe anzuzeigen.", 
    "Successfully started task to reset attempts for problem '<%= problem_id %>'. Click the 'Show Background Task History for Problem' button to see the status of the task.": "Die Aufgabe die Anzahl der Versuche der Probleml\u00f6sung f\u00fcr die Fragestellung  '<%= problem_id %>' zur\u00fcckzusetzen wurde erfolgreich gestartet. Klicke den 'Zeige den Verlauf der Hintergrundaufgaben f\u00fcr Aufgaben'-Knopf um den Status der Aufgabe anzuzeigen.", 
    ...
    "Teams": "Teams", 
    "Tell other learners a little about yourself: where you live, what your interests are, why you're taking courses, or what you hope to learn.": "Erz\u00e4hlen Sie anderen Lernenden ein bi\u00dfchen \u00fcber sich selbst: was interessiert Sie, warum nehmen Sie an den Kursen teil und was m\u00f6chten Sie gern lernen. ", 
    ...
    "Thank you for submitting your photos. We will review them shortly. You can now sign up for any %(platformName)s course that offers verified certificates. Verification is good for one year. After one year, you must submit photos for verification again.": "Danke f\u00fcr das Einsenden ihre Fotos. Wir werden sie bald \u00fcberpr\u00fcfen. Sie k\u00f6nnen sich jetzt beliebig f\u00fcr %(platformName)s Kurse mit \u00fcberpr\u00fcfte Zertifikate anmelden. Ihre \u00dcberpr\u00fcfung ist g\u00fcltig f\u00fcr ein Jahr. Nach ein Jahr m\u00fcssen Sie ihre Fotos f\u00fcr \u00dcberpr\u00fcfung wieder einsenden. ", 
    ...
    "These settings include basic information about your account. You can also specify additional information and see your linked social accounts on this page.": "Diese Einstellungen beinhalten allgemeine Informationen \u00fcber Ihr Konto. Sie k\u00f6nnen zus\u00e4tzliche Informationen eintragen und Ihre verlinkten sozialen Kontos auf dieser Seite einsehen.", 
    ...
    "This may be happening because of an error with our server or your internet connection. Try refreshing the page or making sure you are online.": "Dieser Fehler wurde durch einen Fehler auf unserem Server oder mit Ihrer Internetverbindung verursacht. Versuchen Sie die Seite neu zu laden und/oder pr\u00fcfen sie ihre Internetverbindung", 
    ...
    "Type": "Typ", 
    "URL": "URL", 
    "Unable to retrieve data, please try again later.": "Daten konnten nicht geladen werden. Bitte versuche es sp\u00e4ter noch einmal.", 
    ...
    "Updating with latest library content": "Aktualisiere mit dem neuesten Bibliotheksinhalt", 
    "Upload": "Hochladen", 
    ...
    "Use bookmarks to help you easily return to courseware pages. To bookmark a page, select Bookmark in the upper right corner of that page. To see a list of all your bookmarks, select Bookmarks in the upper left corner of any courseware page.": "Verwende Lesezeichen, die dir das Zur\u00fcckkehren zu einer Seite mit Kursinhalten zu erleichtern. Klicke in der oberen rechten Ecke einer Seite auf Lesezeichen, um ein Lesezeichen zu setzen. Um eine Liste mit all deinen Lesezeichen zu sehen, kannst Du auf jeder Seite oben links auf Lesezeichen klicken.", 
    ...
    "VideoPlayer: Element corresponding to the given selector was not found.": "Videoplayer: Das zu diesem Auswahlelement zugeh\u00f6rige Teil wurde nicht gefunden.", 
    "View": "Ansicht", 
    "View Archived Course": "Archivierte Kurse anzeigen", 
    "View Certificate": "Zertifikat anschauen", 
    ...
    "We've sent a message to {email_address}. Click the link in the message to reset your password.": "Eine Email wurde versendet an {email}. Benutzen sie den Link in der E-mail um das Passwort zu \u00e4ndern.", 
    "Web:": "Web:", 
    "Webcam": "Webcam", 
    ...
    "You have been logged out of your edX account. ": "Du wurdest von deinem edX-Benutzerkonto abgemeldet.", 
    "You have no handouts defined": "Sie haben keine Informationsmaterialien definiert.", 
    "You have not bookmarked any courseware pages yet.": "Du hast bislang f\u00fcr keine Seiten mit Kursinhalten Lesezeichen gesetzt.", 
